...
const getLeaveReportsExcel = async (req, res) => {
    try {
...
async function fetchData({ token, year, month, pageNo, limit, empCode, empId, subCompId, branchId, departmentId, subDepartmentId, locationID, designationId, sortOrder }) {
    try {
        const config = {
            ...
            method: 'POST',
            // url: 'http://localhost:3000/reports/getLeaveReportsExcel',
            url:`${process.env.BASE_URL}/reports/getLeaveReportsExcel`,
...
async function getLeaveReportsExcelSheet(req, res) {
    try {
...
module.exports = { getLeaveReportsExcel, getLeaveReportsExcelSheet }
