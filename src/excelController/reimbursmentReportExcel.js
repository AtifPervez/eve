...
const getAllReimbursmentReportExcel = async (req, res) => {
    ...
    try {
        ...
        let limit = parseInt(req.body.limit) || reiburshmentArr.length
        ...
        let reiburshmentReport=paginatedData.map((e,i)=>({
            ...
            'Approval Status':e.approveStatus,
        ...
        res.status(200).send({
            ...
            reimburshmentList: reiburshmentReport
...
async function fetchData({ year,month }) {
    ...
    try {
        ...
        const config = {
            ...
            // url: 'http://localhost:3000/report/getReimbursmentReportExcel',

            url:`${process.env.BASE_URL}/report/getReimbursmentReportExcel`,
...
async function createExcelFile(data) {
    ...
    let reimburshmentList = data.reimburshmentList

    let header = Object.keys(reimburshmentList[0])



    values.push(header)

    reimburshmentList.forEach(e => {
...
async function getAllReimbursmentReportExcelSheet(req, res) {
    ...
    try {
        ...
        if(apiData.reimburshmentList.length==0){
        ...
        res.setHeader('Content-Disposition', `attachment; filename="reimbursmentReport ${month}-${year}.xlsx"`);
...
module.exports = { getAllReimbursmentReportExcel,getAllReimbursmentReportExcelSheet }