...
const getPfReportExcel = async (req, res) => {
    ...
    try {
        ...
        let pfReportExcel = paginatedData.map((e, i) => ({
        ...
        return res.status(200).send({
            ...
            // },
             ...
             April: apr, May: may, June: jun, July: jul, August: aug, September: sep, October: oct, November: nov, December: dec,January: jan, February: feb, March: mar,
...
async function fetchData({ finYear }) {
    ...
    try {
        ...
        const config = {
            ...
            url:`${process.env.BASE_URL}/report/getPfReportExcel`,
...
async function getPfReportExcelSheet(req, res) {

    try {

       

        let finYear = req.query.finYear||req.body.finYear
        ...
        res.setHeader('Content-Disposition', `attachment; filename="pfReport ${finYear}.xlsx"`);
...
module.exports = { getPfReportExcel, getPfReportExcelSheet }