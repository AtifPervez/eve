...
const getResignationReportExcel = async (req, res) => {
            ...
            resignDb.map( async(x,j) => {
                ...
                if (e.id == x.id) {
                    ...
                    if (x.r1Status == 'Approved' && x.r1Id != '') {
                        ...
                        e.r1Name=`R1- ${await getEmployeeNameById(x.r1Id)}`,
                    ...
                    if (x.r2Status == 'Approved' && x.r2Id != '') {
                        ...
                        e.r2Name=`R2-${await getEmployeeNameById(x.r2Id)}`
                    ...
                    if (x.r3Status == 'Approved' && x.r3Id != '') {
                        ...
                        e.r3Name=`R3-${await getEmployeeNameById(x.r3Id)}`
...
async function fetchData({ year, month }) {
    ...
    try {
        ...
        const config = {
            ...
            // url: 'http://localhost:3000/report/getResignationReportExcel',

            url:`${process.env.BASE_URL}/report/getResignationReportExcel`,
...
async function createExcelFile(data) {
    ...
    let resignationReportList = data.resignationReportList

    let header = Object.keys(resignationReportList[0])
    ...
    resignationReportList.forEach(e => {
...
async function getResignationReportExcelSheet(req, res) {
    ...
    try {
        ...
        let year = req.body.year
            ...
            res.setHeader('Content-Disposition', 'attachment; filename="resignationReportExcelSheet.xlsx"');
...
module.exports = { getResignationReportExcel,getResignationReportExcelSheet}