...
async function fetchData({year, month }) {
    ...
    try {
        ...
        const config = {
            ...
            url:`${process.env.BASE_URL}/report/getVpfReportExcel`,
...
async function getVpfReportExcelSheet(req, res) {
    ...
    try {
        ...
        res.setHeader('Content-Disposition', 'attachment; filename="vpfReportExcelSheet.xlsx"');
...
module.exports = { getVpfReportExcel, getVpfReportExcelSheet }
