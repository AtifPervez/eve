...
const getTdsReportExcel = async (req, res) => {
    ...
    try {
        ...
        for (i in getData) {
            ...
            if (e.employeeSubcompanyName == null) {

                e.employeeSubcompanyName = ''
        ...
        let tdsReportExcel = paginatedData.map((e, i) => ({
            ...
            'paidByWithDateTime': e.paidByWithDateTime,
        ...
        return res.status(200).send({
            ...
            "Total of April": apr, 'Total of May': may, 'Total of June': jun, 'Total of July': jul, 'Total of August': aug, 'Total of September': sep, 'Total of October': oct, 'Total of November': nov, 'Total of December': dec, 'Total of January': jan, 'Total of February': feb, 'Total of March': mar,

            employeeList: tdsReportExcel,
...
async function fetchData({ finYear }) {
    ...
    try {
        ...
        const config = {
            ...
            // url: 'http://localhost:3000/report/getTdsReportExcel',

            url:`${process.env.BASE_URL}/report/getTdsReportExcel`,
...
async function getTdsReportExcelSheet(req, res) {
    ...
    try {
        ...
        res.setHeader('Content-Disposition', `attachment; filename="TdsReport ${finYear}.xlsx"`);
...
module.exports = { getTdsReportExcel, getTdsReportExcelSheet }