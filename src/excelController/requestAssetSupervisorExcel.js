...
const getRequestAssetSupervisorExcel = async (req, res) => {
...
async function fetchData({ token, pageNo, limit, empCode, empId, subCompId, branchId, locationId, departmentId, subDepartmentId, designationId, categoryId, assetName, tagResposibleId, reguestDateFrom, requestDateTo, status }) {
    ...
    try {
        ...
        const config = {
            ...
            // url: 'http://localhost:3000/employeeMaster/getRequestSupervisorAssetListExcel',

            url:`${process.env.BASE_URL}/employeeMaster/getRequestSupervisorAssetListExcel`,



            data: { token, pageNo, limit, empCode, empId, subCompId, branchId, locationId, departmentId, subDepartmentId, designationId, categoryId, assetName, tagResposibleId, reguestDateFrom, requestDateTo, status }
...
async function getRequestAssetSupervisorExcelSheet(req, res) {
    ...
    try {
        ...
        let assetName = req.body.assetName || req.query.assetName
        ...
        let apiData = await fetchData({
            ...
            token, pageNo, limit, empCode, empId, subCompId, branchId, departmentId, subDepartmentId, designationId, categoryId, assetName, tagResposibleId, reguestDateFrom, requestDateTo, status
        ...
        res.setHeader('Content-Disposition', `attachment; filename="requestSupervisorAssetExcelSheet.xlsx"`);
...
module.exports = {
    ...
    getRequestAssetSupervisorExcel,

    getRequestAssetSupervisorExcelSheet
