...
const getAllotAssetListExcel = async (req, res) => {
    ...
    try {
        ...
        let allotAssetListExcel = paginatedData.map((e, i) => ({
            ...
            // 'Allotted By': e.taggedResponsiblePerson,
        ...
        if (reguestDateFrom && reguestDateFrom) {
...
async function fetchData({ token, pageNo, limit, empCode, empName, subCompId, branchId, locationId, departmentId, subDepartmentId, designationId, categoryId, assetId, taggedResponsible, reguestDateFrom, requestDateTo, status }) {
    ...
    try {
        ...
        const config = {
            ...
            // url: 'http://localhost:3000/employeeMaster/getAllotAssetListExcel',

            url:`${process.env.BASE_URL}/employeeMaster/getAllotAssetListExcel`,



            data: { token, pageNo, limit, empCode, empName, subCompId, branchId, locationId, departmentId, subDepartmentId, designationId, categoryId, assetId, taggedResponsible, reguestDateFrom, requestDateTo, status }
...
async function getAllotAssetListExcelSheet(req, res) {
    ...
    try {
        ...
        let apiData = await fetchData({
            ...
            token, pageNo, limit, empCode, empName, subCompId, branchId, departmentId, subDepartmentId, designationId, categoryId, assetId, taggedResponsible, reguestDateFrom, requestDateTo, status
        ...
        res.setHeader('Content-Disposition', `attachment; filename="allotAssetList.xlsx"`);
...
module.exports = { getAllotAssetListExcel, getAllotAssetListExcelSheet }
